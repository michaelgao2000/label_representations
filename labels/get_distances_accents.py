...
num_classes = 10
labels = [
    f"cifar{num_classes}_accents_speechamerican.npy",
    f"cifar{num_classes}_accents_speechaustralian.npy",
    f"cifar{num_classes}_accents_speechbritish.npy",
    f"cifar{num_classes}_accents_speechnewzealand.npy",
    f"cifar{num_classes}_accents_speechsouthafrican.npy",
]
